 ...
 * Invocation)}. the trace context transport to the provider side by {@link RpcContext#getServerAttachment}.but all the version
 * of dubbo framework below 3.0.0 don't support {@link RpcContext#getClientAttachment}, we support another way to support it.
 */
public class DubboInterceptor implements InstanceMethodsAroundInterceptor {
     ...
     * {@link RpcContext#getServerAttachment}. current trace segment will ref if the serialize context data is not null.
     */
    @Override
